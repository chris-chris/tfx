...
class PerformRewriteTest(absltest.TestCase):
  ...
  class MyRewriter(rewriter.BaseRewriter):
    ...
    def __init__(self, pre_rewrite_validate_raises_error,
                 rewrite_raises_error, post_rewrite_validate_raises_error,
  ...
  def testPerformRewriteStopsOnFailedPreRewriteValidation(self):
    rw = self.MyRewriter(
        True, False, False, self._source_model, self._dest_model)
  ...
  def testPeformRewriteStopsOnFailedRewrite(self):
    rw = self.MyRewriter(
        False, True, False, self._source_model, self._dest_model)
  ...
  def testPerformRewriteStopsOnFailedPostRewriteValidation(self):
    rw = self.MyRewriter(
        False, False, True, self._source_model, self._dest_model)
